...
| `@an5/adapters` | npm | `0.1.1` | Published | Runtime database adapters for TypeScript apps |
| `@an5/agent` | npm | `0.1.1` | Published | AI database agent with 7 consolidated tools |
| `an5-adapters` | PyPI | `0.1.1` target | Build-ready | Wheel/sdist pass `twine check`; upload requires PyPI token |
...
| `npx an5 db:push` | Implemented | Create tables and add missing columns from schema |
